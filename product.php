				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
					<div class="leftbar p-r-20 p-r-0-sm">
						...
						<ul class="p-b-54">
							...
							foreach($queryCat as $cat_id){
							
							?>
							<li class="p-t-4">
								<a href="?cat_id=<?= $cat_id['id'] ?>" class="s-text13">
									<?= $cat_id['name'] ?>
								</a>
							</li>
							<?php }; ?>
				...
				<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
					...
					<div class="row">
						...
						if(isset($_GET['cat_id'])){
							$cat =$_GET['cat_id'];
						$select="SELECT * FROM products WHERE cat_id=$cat";
							...
							<div class="block2">
								<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
									<?php
										...
										$select_img="SELECT * FROM images WHERE product_id=$product_id LIMIT 1";
										$query_img=$conn-> query($select_img);
										foreach($query_img as $img){
									?>
								<img src="Admin/imgs/<?= $img['name'] ?> "style="width: 200px;" alt="IMG-PRODUCT">
									<?php }; ?>
